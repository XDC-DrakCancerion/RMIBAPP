...
/**
 * (Opsional tapi disarankan) Validasi: peserta hanya boleh download miliknya.
 * Jika kamu simpan id_pengguna di tbl_peserta:
 */
$userId = (int)$_SESSION['user']['id_pengguna'];
if ((int)$peserta['id_pengguna'] !== $userId) {
  flash_set('error', 'Anda tidak berhak mengakses hasil ini.');
  redirect('hasil.php');
}
