...
// Jika ada kategori yang belum ada deskripsinya, isi '-'
foreach ($categories as $code) {
    if (!isset($kategoriKet[$code]) || trim($kategoriKet[$code]) === '') {
        $kategoriKet[$code] = '-';
    }
}
